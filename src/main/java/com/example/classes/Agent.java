...
public class Agent extends Actor implements Cloneable{
    ...
    public Agent(
            ...
            Position[] groundPos,
            int id) {
        super(scene, startPos.x * 32, startPos.y * 32, id, false);
        this.startPos = startPos;
        this.endPos = endPos;
        this.groundPos = groundPos;

        this.astar = new ACO(52, 28, startPos, endPos, groundPos);
